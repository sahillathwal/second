...
void main() {
  ...
  group('SecondApiClient', () {
    late http.Client httpClient;
    late SecondApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = SecondApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => SecondApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = SecondApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws SecondApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<SecondApiMalformedResponse>()),
        );
      });

      test(
          'throws SecondApiRequestFailure '
