...
/// {@endtemplate}
class SecondApiMalformedResponse implements Exception {
  /// {@macro second_api_malformed_response}
  const SecondApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template second_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class SecondApiRequestFailure implements Exception {
  /// {@macro second_api_request_failure}
  const SecondApiRequestFailure({
...
/// {@template second_api_client}
/// A Dart API client for the second API.
/// {@endtemplate}
class SecondApiClient {
  /// Create an instance of [SecondApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro second_api_client}
  SecondApiClient({
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        SecondApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
